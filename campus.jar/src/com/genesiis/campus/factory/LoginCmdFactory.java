...
//20170426 AS c155-admin-logout-function-as CmdAdminLogout command added
import com.genesiis.campus.command.CmdAdminLogin;
import com.genesiis.campus.command.CmdAdminLogout;
...
public class LoginCmdFactory implements ICmdFactory {
	...
	static {
		...
		map.put(Operation.ADMIN_LOGOUT, new CmdAdminLogout());
	}
