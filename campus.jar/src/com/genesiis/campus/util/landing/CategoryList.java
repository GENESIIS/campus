...
//20170301 PN CAM-137: modified Enum by adding category string value into it.
...
public enum CategoryList {
	...
	HigherEducation("2","Higher Education","Higher Education Description","HIGHER_EDUCATION"),
	CorporateTraining("3","Corporate Training","Corporate Training Education Description","CORPORATE_TRAINING"),
	PreEducation("4","Pre Education","Pre Education Description","PRE_EDUCATION");
	...
	private CategoryList(String code, String name, String description, String categoryString) {
		this.code = code;
		this.name = name;
