...
//20161102 CM c9-make-inquiry-for-institute Modified setProperties() method, Removed unused variables.
...
/**
 * GeneralMail class captures the essence of an email and binds email related
 * properties such as from, to ,message context , subject and the system
 * properties related to Mailing protocol.
 * 
 * @author DN
 * 
 */
public class GeneralMail implements IEmail {
	 ...
	 * @author DN
	 * @param receivers
	 *            to list of the email ArrayList<String>
	 * @param sender
	 *            String: email address of the person who sends the email
	 * @param host
	 *            String: Mail transferring host or the domain address
	 * @param subject
	 *            String: subject of the email
	 * @param emailBody
	 *            String : body content of the email
	 */
	public GeneralMail(ArrayList<String> receivers, String sender,String subject, String emailBody) {
	...
	/**
	 * setEmailMessage() setup sender,receiver list,subject,and the message
	 * bodyand the date of generating the email
	 * 
	 * @author DN
	...
	public MimeMessage setEmailMessage() throws MessagingException {
		try {
			...
			log.error("sendEmail(MimeMessage message):MessagingException :"
					+ mex.toString());
			throw mex;
		}
	...
	/*
	 * setSystemPropertiesAndMailEnvironment sets system properties relates to
	 * mailing and creates MimeMessage instance
	 * 
	 * @author DN
	 */
	...
	private void setProperties() {
		try {
			...
			log.error("setProperties() Exception:" + exception.toString());
	...
	/*
	 * addRecipientToMail() unfolds the list of recipients and add to the
	 * message mailing list only if the element is not null.
	 * 
	 * @author DN
	 * 
	 * @param receiversList list of recipient ,MimeMessage message being context
	 */
	private void addRecipientToMail(MimeMessage message,
			ArrayList<String> receiversList) throws MessagingException {
	 ...
	 * @throws MessagingException
	 */
	private void setSentDateToMail(MimeMessage message)
			throws MessagingException {
	 ...
	 */
	private void addSenderToMail(MimeMessage message, String sender)
			throws MessagingException {
