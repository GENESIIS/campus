...
/**
 * TutorPasswordResetEmailComposer class handles the composing & formatting the email to be sent
 * to verify the email address.
 * @author Chinthaka CW
 */
public class TutorPasswordResetEmailComposer implements IEmailComposer, EmailContentCreator  {
	static Logger log = Logger.getLogger(TutorPasswordResetEmailComposer.class.getName());
 ...
 * @author CHINTHAKA
 */
	public TutorPasswordResetEmailComposer(){
