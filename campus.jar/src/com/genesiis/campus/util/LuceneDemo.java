...
public class LuceneDemo {
	...
	public static final Path INDEX_DIRECTORY = Paths.get("./indexdir");
...
//		luceneDemo.deletDocumentFromIndex();
	...
	public void createLuceneIndex() throws SQLException{
	...
	public void createIndexSearcher() throws CorruptIndexException, IOException{
...
//	}
	 ...
	 */
	public void prefixQueryExample(){
	 ...
	 */
	public void queryParserExample(){
...
//	}
	 ...
	 */
	public void fieldBoostFactorExample(){
	...
	public void sortBySenderExample(){
		
		/* Search mails having the word 'job' in subject and return results
		   sorted by sender's email in descending order.
		 */
		SortField sortField = new SortField("sender", SortField.Type.STRING_VAL, true);  //("sender",null, true);	
