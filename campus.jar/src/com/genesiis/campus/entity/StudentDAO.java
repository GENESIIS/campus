...
public class StudentDAO implements ICrud {
	...
	public Collection<Collection<String>> findById(Object code)
			throws SQLException, Exception {final Collection<Collection<String>> corporateProgrammeList = new ArrayList<Collection<String>>();
			...
			try {
				...
				retrieveStudentsFromResultSet(rs, corporateProgrammeList);
