...
SELECT TUTOR.CODE, TUTOR.USERNAME, TUTOR.LANDPHONECOUNTRYCODE, TUTOR.MOBILEPHONECOUNTRYCODE, COUNTRY2.NAME
FROM [CAMPUS].[TUTOR], [CAMPUS].[COUNTRY2]
WHERE TUTOR.CODE = 40
JOIN 
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
SELECT T.CODE, T.USERNAME, T.LANDPHONECOUNTRYCODE, T.MOBILEPHONECOUNTRYCODE, C.NAME
FROM [CAMPUS].[TUTOR] T
...
SELECT T.CODE, T.USERNAME, T.LANDPHONECOUNTRYCODE, T.MOBILEPHONECOUNTRYCODE, C.NAME, TOWN.NAME
FROM [CAMPUS].[TUTOR] T
JOIN [CAMPUS].[COUNTRY2] C ON C.CODE = T.LANDPHONECOUNTRYCODE
JOIN [CAMPUS].[TOWN] TOWN ON TOWN.CODE = T.TOWN
WHERE T.CODE = 40					
