...
-- v16 - 20161214 - MM 
-- Added INTERFACE column to BUTTONACTION table
-- Added foreign key constraint to INTERFACE coulumn in BUTTONACTION table
-- Changed name of NOT NULL constraint on Action column to DF_BUTTONACTION_ACTION
...
CREATE TABLE [CAMPUS].[BUTTONACTION](
    ...
    ACTION VARCHAR(100)  NOT NULL CONSTRAINT DF_BUTTONACTION_ACTION DEFAULT (''),
    INTERFACE INT NOT NULL CONSTRAINT DF_BUTTONACTION_INTERFACE DEFAULT (1),
    ...
    CONSTRAINT FK_BUTTONACTION_INTERFACE FOREIGN KEY (INTERFACE) REFERENCES [CAMPUS].[INTERFACE]
);
