...
CREATE TABLE [CAMPUS].[AWARD](
    ...
    LONGTITLE VARCHAR(20) NOT NULL CONSTRAINT DF_AWARD_LONGTITLE DEFAULT ('') ,
...
CREATE TABLE [CAMPUS].[SCHOOLEDUCATION](
    ...
    INDEXNO INT NOT NULL CONSTRAINT DF_SCHOOLEDUCATION_INDEXNO DEFAULT 0 ,
    ...
    DESCRIPTION VARCHAR(500) NOT NULL CONSTRAINT DF_SCHOOLGRADE_DESCRIPTION DEFAULT ('') ,
