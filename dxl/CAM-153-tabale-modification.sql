...
//admin privilege query WIP

SELECT INTERFACE.URL , BUTTONACTION.ACTION FROM CAMPUS.USERTYPE 
INNER JOIN CAMPUS.PRIVILEGE ON USERTYPE.CODE = PRIVILEGE.USERTYPE 
INNER JOIN CAMPUS.INTERFACE ON PRIVILEGE.INTERFACE = INTERFACE.CODE	
INNER JOIN CAMPUS.BUTTONACTION ON BUTTONACTION.INTERFACE = INTERFACE.CODE WHERE BUTTONACTION.ISACTIVE=1 AND INTERFACE.ISACTIVE=1 AND PRIVILEGE.ISACTIVE=1 AND USERTYPESTRING ='ADMIN';
