...
BEGIN
	...
	ex.EXPCODE, ex.TUTOREX, ex.ORGANIZATION, ex.INDUSTRY, ex.JOBCATEGORY, ex.DESIGNATION, ex.COMMENCEDON, ex.COMPLETIONON, md.MODULENAME, md.MODULECODE, md.MTUTOR, md.PROGRAMNAME, emp.CPCODE, emp.COURSEPROVIDRE, emp.EMPTUTOR
