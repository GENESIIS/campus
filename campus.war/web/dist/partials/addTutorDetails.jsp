		...
		<table align="center">
			...
			<tr>
				...
				<td><input type="text" name="firstname" id="firstName"
					maxlength="20" onchange="clearField('firstNameError')" /><span
					id="firstNameError" style="color: red"> </span></td>
			</tr>
			<tr>
				<td>Middle Name</td>
				<td><input type="text" name="middlename" id="middleName"
					maxlength="20" onchange="clearField('middleNameError')" /><span
					id="middleNameError" style="color: red"></span></td>
			</tr>
			<tr>
				<td>Last Name *</td>
				<td><input type="text" name="lastname" id="lastName"
					maxlength="20" onchange="clearField('lastNameError')" /><span
					id="lastNameError" style="color: red"></span></td>
			</tr>
			<tr>
				<td>Gender *</td>
			...
			<tr>
				...
				<td><textarea rows="10" cols="26" name="experience"
						id="experience" onchange="clearField('experienceError')"></textarea><span
					id="experienceError" style="color: red"></span></td>
			</tr>
			<tr>
				<td>About Me </span></td>
				<td><textarea rows="10" cols="26" name="aboutMe" id="aboutMe"
						onchange="clearField('aboutMeError')"></textarea><span
			...
			<tr>
				...
				<td><input type="text" name="mobileCountryCode"
					...
					onchange="clearField('mobileError')" readonly /><span
					id="mobileError" style="color: red"></span></td>

				<td><input type="text" name="mobileNetworkCode"
					id="mobileNetworkCode" maxlength="10"
					onchange="clearField('mobileNetworkError')" /><span
					id="mobileNetworkError" style="color: red"></span></td>

				<td></span> <input type="text" name="mobileNumber" id="mobileNumber"
					maxlength="11" onchange="clearField('mobileNumberError')" /><span
					id="mobileNumberError" style="color: red"></td>
			</tr>
			<tr>
				<td>Land *</td>
				<td><input type="text" name="landCountryCode"
					id="landCountryCode" maxlength="5"
					onchange="clearField('landError')" readonly /><span id="landError"
					style="color: red"></span></td>

				<td><input type="text" name="landAreaCode" id="landAreaCode"
					maxlength="10" onchange="clearField('landAreaCodeError')" /><span
					id="landAreaCodeError" style="color: red"></span></td>

				<td><input type="text" name="landNumber" id="landNumber"
					maxlength="10" onchange="clearField('landNumberError')" /><span
					id="landNumberError" style="color: red"></span></td>
			</tr>
			<tr>
				<td>Address Line 1 *</td>
				<td><input type="text" name="address1" id="address1"
					maxlength="30" onchange="clearField('address1Error')" /><span
					id="address1Error" style="color: red"></span></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="weblink" id="weblink"
					onchange="clearField('weblinkError')" /><span id="weblinkError"
					style="color: red"></span></td>
			</tr>
			<tr>
				<td>Facebook </span></td>
				<td><input type="text" name="facebook" id="facebook"
					onchange="clearField('facebookError')" /><span id="facebookError"
					style="color: red"></td>
			</tr>
			<tr>
				<td>LinkedIn</td>
				<td><input type="text" name="linkedin" id="linkedin"
					onchange="clearField('linkedInError')" /><span id="linkedInError"
					style="color: red"></span></td>
			</tr>
			<tr>
				<td>Twitter</td>
				<td><input type="text" name="twitter" id="twitter"
					onchange="clearField('twitterError')" /><span id="twitterError"
					style="color: red"></span></td>
			</tr>
			<tr>
				<td>Instagram</td>
				<td><input type="text" name="instagram" id="instagram"
					onchange="clearField('instagramError')" /><span
					id="instagramError" style="color: red"></span></td>
			</tr>
			<tr>
				<td>Myspace</td>
				<td><input type="text" name="myspace" id="myspace"
					onchange="clearField('mySpaceError')" /><span id="mySpaceError"
					style="color: red"></span></td>
			</tr>
			<tr>
				<td>WhatsApp</td>
				<td><input type="text" name="whatsapp" id="whatsapp"
					maxlength="20" onchange="clearField('whatsappError')" /><span
					id="whatsappError" style="color: red"></span></td>
			</tr>
			<tr>
				<td>Viber</td>
				<td><input type="text" name="viber" id="viber" maxlength="20"
					onchange="clearField('viberError')" /><span id="viberError"
					style="color: red"></span></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="email" id="email"
					onchange="clearField('emailError')" /><span id="emailError"
					style="color: red"></span></td>
			</tr>
			<tr>
				<td>Username *</td>
				<td><input type="text" name="username" id="username"
					maxlength="20" onchange="clearField('usernameError')" /><span
					id="usernameError" style="color: red"></span></td>
			</tr>
			<tr>
				<td>Password *</td>
