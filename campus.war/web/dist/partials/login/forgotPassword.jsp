	...
	<div align="center">
	 <div class="input-panel col-md-6 col-lg-6 col-sm-12 clearfix">
            ...
            <div class="input-field">
                ...
                <input class="text-field" type="password" name="psw" id="passWord" onclick="clearField('passWordError')" onkeypress="validatePasswordResetData()">
            ...
            <!-- End Confirm password  -->
             <div class="input-field">
                <button class="btn-create" onclick="changedPassword()" name="CCO" id="CCO" value="RESETPASS"> Changed Password </button>
