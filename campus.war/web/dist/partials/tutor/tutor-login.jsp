...
<!-- 20170505 AS c99-tutor-login-function-as- tutor-login.jsp sample page created -->
<!-- 20170505 AS c99-tutor-login-function-as - sample UI design -->
					...
					<div class="col-sm-3">
						...
						<form name="adminLogin" class="form-vertical form-user" role="form"	method="" action="">
							...
							<div class="form-group">
								...
								<button type="button" class="btn btn-primary btn-block" name="CCO" id="CCO" value="ALOG" onclick="TutorLogin(); resetLoginLabels();">Sign In</button> 
