...
<!-- 20170102 PN CAM-27: added JavaScript code to reset model preview after remove image from the uploader. -->
<%
...
<link href="/dist/bower-components/bootstrap/bootstrap.min.css"
	rel="stylesheet">
<link href="/dist/bower-components/bootstrap/font-awesome.min.css"
...
<link href="/dist/css/imageUpload/fileinput.css" media="all"
...
$(function() {	
    $("#btnchangestdpropic").click(function(){
        ...
        $(".modal-body1").html('<div id="kv-avatar-errors-1" class="center-block"'+
				...
				'<form class="text-center" action="/PublicController" method="post"'+
				...
				<div class="left-side col-md-3 col-lg-3 col-sm-12 clearfix">
					<div class="prf-pic-holder">
						<div class="prf-image">
							...
							<img id="profImage"
								src="../../../<c:out value="${proPicPath}" />"
								alt="Profile-Picture">
							<button class="btn-image-change hvr-icon-float-away"
								id="btnchangestdpropic">Change Image</button>
						</div>
						<!-- End profile image -->
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal"
						id="userImageModalClose">Close</button>
				</div>
			</div>
