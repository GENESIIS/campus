/**
 * 20170206 PN CAM-137 INIT file to implement error handling methods 20170215 PN
 * CAM-137 removed unwanted alert message.
 */

/*
 * This method will format the error message and will display it to the user.
 * @param x - error details as a JSON object @param status - error status @param
 * error - actual error.
 */
function displayErrorMessage(x, status, error) {
	...
	if (startingValue == '4') {
		errorMessage = errorCode + ": " + getClientErrorMessage(errorCode);
