...
<!-- Header-->
<header ng-include="'partials/layout/header.jsp'"></header>

<!-- Main Container  -->
<div ng-view></div>

<!-- Footer -->
<footer ng-include="'partials/layout/footer.jsp'"></footer>

<!-- AngularJS -->
<script src="bower-components/angular/angular.min.js"></script>
<script src="bower-components/angular/angular-route.min.js"></script>
